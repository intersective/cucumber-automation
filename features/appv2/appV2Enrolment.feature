Feature: AppV2 enrolment
	...
	Scenario: Test AppV2 enrolment
		...
		Then "Mailtrap" I search email with title "App V2 Automation Program - Welcome and Register" and the student as receiver
		...
		Then I wait 2 seconds
		Then "Mailtrap" I search email with title "App V2 Automation Program - Welcome and Register" and the student2 as receiver
		Then "Mailtrap" I go into the email content
