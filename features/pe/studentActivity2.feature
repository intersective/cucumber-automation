...
Feature: Personal Edge Student Confident Communicator Activity
    ...
    Scenario: Test Personal Edge Student Personal Edge Student Confident Communicator Activity
        ...
        Then "PE" I can see an activity locating at "2" position with "0" tick
        Then "PE" I can see an activity locating at "2" position with "0" score
        Then "PE" I go to "2" activity
        Then "PE" I can see "0" submissions for "Confident Communicator" activity
        Then "PE" I can add a new submission
        Then "PE" I can see an assessment with title "CONFIDENT COMMUNICATOR"
