Feature: Personal Edge Student Cross-Cultural Team Player Activity
	...
	so that I can start to taking the fifth activity
    ...
    Scenario: Test Personal Edge Student Personal Edge Student Cross-Cultural Team Player Activity
        ...
        Then "PE" I go to "5" activity
        Then "PE" I can see "0" submissions for "Cross-Cultural Team Player" activity
        Then "PE" I can add a new submission
        Then "PE" I can see an assessment with title "CROSS-CULTURAL TEAM PLAYER"
        ...
        Then "PE" I do the questions with:
            ...
            | text | Task | I am really into the Cross-Cultural Team Player part |
            | text | Action | I am really into the Cross-Cultural Team Player part |
            | text | Result | I am really into the Cross-Cultural Team Player part |
            | text | Learn / Plan | I am really into the Cross-Cultural Team Player part |
        Then I wait 2 seconds
        Then I click on "save button" which is located at "assessments-group-page ion-navbar.toolbar ion-buttons button.btn-save"
        Then I wait 2 seconds
        Then "PE" I wait for loading finished
