...
Feature: Personal Edge Student Career Strategist Activity
    ...
    Scenario: Test Personal Edge Student Personal Edge Student Career Strategist Activity
        ...
        Then "PE" I can see an activity locating at "4" position with "0" tick
        Then "PE" I can see an activity locating at "4" position with "0" score
        Then "PE" I go to "4" activity
        Then "PE" I can see "0" submissions for "Career Strategist" activity
        Then "PE" I can add a new submission
        Then "PE" I can see an assessment with title "CAREER STRATEGIST"
