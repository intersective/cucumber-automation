...
Feature: Appv1 slider type questions
    ...
    Scenario: Test Appv1 slider type questions for a student who is not in a team
        ...
        Then I should see "the first slider question description" which is located at "//*[@ng-repeat='question in modal.questions'][1]//*[@ng-if='question.description'][text()='You should engage with your mentor at least once every fortnight.']" with xpath scroll
        ...
        Then I should see "the second slider question title" which is located at "//*[@ng-repeat='question in modal.questions'][2]//*[text()='Q2. Do you feel that your team is on track (team)?']" with xpath scroll
        Then I should see "the second slider question description" which is located at "//*[@ng-repeat='question in modal.questions'][2]//*[@ng-if='question.description'][text()='Do you feel that your team is on track?']" with xpath scroll
        ...
        Then I should see "the third slider question title" which is located at "//*[@ng-repeat='question in modal.questions'][3]//*[text()='Q3. Do you feel that your team is on track(mentor)?']" with xpath scroll
        Then I should see "the third slider question description" which is located at "//*[@ng-repeat='question in modal.questions'][3]//*[@ng-if='question.description'][text()='Do you feel that your team is on track?']" with xpath scroll
        ...
        Then I should see "the fourth slider question title" which is located at "//*[@ng-repeat='question in modal.questions'][4]//*[text()='Q4. In which stage do you think your team is at?']" with xpath scroll
        Then I should see "the fourth slider question description" which is located at "//*[@ng-repeat='question in modal.questions'][4]//*[@ng-if='question.description'][text()='In which stage do you think your team is at? Refer to the project content if you are unsure which about the different stages.']" with xpath scroll
        ...
        Then I should see "submission completed messages" which is located at "//*[@class='popup']//*[text()='Submission Completed!']" with xpath
        Then I click on "close button" which is located at ".popup-container button"
