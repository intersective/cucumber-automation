Feature: Appv1 slider type questions
    ...
    Scenario: Test Appv1 slider type questions for a student who is not in a team(Generic App v1 program - Barry(test.barry@practera.com))
        Given I go to "https://sandbox.practera.com/surl/434e7be"
        ...
        Then I can see a group of "fast feedback questions" with total "3" which is located at "[ng-repeat='question in modal.questions']"
        ...
        Then I should be able to see "the second slider question title" which is located at "//*[@ng-repeat='question in modal.questions'][3]//*[text()='Q3. In which stage do you think your team is at?']" with xpath scroll assert
        Then I should be able to see "the second slider question description" which is located at "//*[@ng-repeat='question in modal.questions'][3]//*[@ng-if='question.description'][text()='In which stage do you think your team is at? Refer to the project content if you are unsure which about the different stages.']" with xpath scroll assert
        ...
        Then I click on "Storming for the thrid question" which is located at "//*[@ng-repeat='question in modal.questions'][3]//span[normalize-space()='Storming']/../../.." with xpath scroll

        Then I click on "submit button" which is located at "ion-modal-view button[type='submit']" with scroll

        Then I go to "https://sandbox.practera.com/surl/434e7be"
        When I wait until the loading finished
