Feature: AppV1 Team Evaluation
	...
	Scenario: Test AppV1 Team Evaluation
		...
		Then "Appv1" I should be able to select "selenium.20180622100741" to team member selector which is located at "//*[@ng-repeat='question in group.questions'][1]//label[1]"
		Then I input "selenium.20180622100741 is a friendly and hard working person" to "evluation text area" which is located at "//*[@ng-repeat='question in group.questions'][2]//textarea" with xpath scroll
