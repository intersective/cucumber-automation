Feature: AppV1 Team Assessment
	...
	Scenario: Test AppV1 Team Assessment
		...
		Then "Appv1" I login with username "selenium.20180616103404@practera.com" and password "12341234"
		...
		Then I input "selenium.20180616104756 is working with us" to "evluation text area" which is located at "//*[@ng-repeat='question in group.questions'][1]//textarea" with xpath scroll
