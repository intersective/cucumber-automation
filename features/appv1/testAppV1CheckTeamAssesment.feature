Feature: AppV1 Check Team Assessment
	...
	Scenario: Test AppV1 Check Team Assessment
		...
		Then "Appv1" I login with username "selenium.20180617124842@practera.com" and password "12341234"
		...
		Then "Appv1" I should be able to see "selenium.20180617124842 is working with us" which is located at "//*[@ng-repeat='question in group.questions'][1]//*[@ng-if='isDone']"
