Feature: AppV1 Check Team Assessment
	...
	Scenario: Test AppV1 Check Team Assessment
		...
		Then "Appv1" I should be able to see "text answers" which is located at "//*[@ng-repeat='question in group.questions'][1]//*[@ng-if='isDone']/*[text()='we are working well']" with xpath scroll assert
		Then "Appv1" I should be able to see "choice answer" which is located at "//*[@ng-repeat='question in group.questions'][2]//*[@ng-if='isDone']//*[text()='Choice Two']" with xpath scroll assert
