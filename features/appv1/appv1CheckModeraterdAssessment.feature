Feature: AppV1 Check Moderated Assessment Answer
    ...
    Scenario: Test Check Moderated Assessment Answer
        ...
        Then I can see "reviewer answer" which is located at "//*[normalize-space()='Q1. Text Question 1']/..//*[text()='Reviewer']/..//*[text()='Answer']/../*[text()='your works are excellent, thank you for submissions']" with xpath scroll
        ...
        Then I can see "expert feedback choice" which is located at "//*[normalize-space()='Q1. Oneof Question 1']/..//*[text()='Reviewer']/..//*[text()='Answer']/../*[text()='Good']" with xpath scroll
        Then I can see "expert feedback text" which is located at "//*[normalize-space()='Q1. Oneof Question 1']/..//*[text()='Reviewer']/..//*[text()='Comment']/../*[text()='your works are excellent, thank you for submissions']" with xpath scroll
        ...
        Then I can see "expert feedback choice" which is located at "//*[normalize-space()='Q1. Multiple Choice Question 1']/..//*[text()='Reviewer']/..//*[text()='Answer']/../*[text()='Choice 1, Choice 0.4']" with xpath scroll
        Then I can see "expert feedback text" which is located at "//*[normalize-space()='Q1. Multiple Choice Question 1']/..//*[text()='Reviewer']/..//*[text()='Comment']/../*[text()='your work is good']" with xpath scroll
