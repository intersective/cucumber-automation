Feature: Practera Admin Edit Review
    ...
    Scenario: Test Practera Admin Edit Review
		...
		Then I click on "Normal" which is located at "//span[starts-with(normalize-space(),'Normal')]" with xpath scroll
		...
		Then I click on "Choice 0.8" which is located at "//span[starts-with(normalize-space(),'Choice 0.8')]" with xpath scroll
		Then I click on "Choice 0.6" which is located at "//span[starts-with(normalize-space(),'Choice 0.6')]" with xpath scroll
